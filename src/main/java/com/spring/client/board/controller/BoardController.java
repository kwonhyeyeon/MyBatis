...
>>>>>>> ce8300afbf20244111a4457a5bab057f327a02c0
...
=======
	 ...
	 * @param b_pwd
	 * 
	 * @return int로 result 0 또는 1을 리턴할 수도 있고 String으로 result 값을 "성공" 또는 "실패"를 리턴할 수도
	 * 있다
	 * 
	 * @ResponseBody는 전달된 뷰를 통해서 출력하는 것이 아니라 HTTP ResponseBody에 직접 출력하는 방식 produes
	 * 속성은 지정한 미디어 타입과 관련된 응답을 생성하는데 사용한 실제 컨텐트 타입을 보장
	 */
	@ResponseBody
