...
<script type="text/javascript">
	$(function(){
		...
		$(".order").click(function(){
			// 클릭된 태그의 속성중 data-value를 찾아서 order_by변수에 저장한다
			// data속성에는 값을 일시적으로 저장하여 사용할수 있다.
		...
		$(".goDetail").click(function(){
			// 클릭된 태그 상위에 있는 tr태그중 data-num속성을 찾아서 b_num 변수에 저장한다.
			// data속성에는 값을 일시적으로 저장하여 쓸수 있다.
	...
	// 검색한 페이지에 보여줄 레코드 수 처리 및 페이징을 위한 실질적인 처리함수.
         ...
         <table summary="게시판 리스트">
            ...
            <thead>
            	<tr>
                  ...
                  <th>글 제목</th>
                  <th class="order" data-value="b_date">작성일
                  	<c:choose>
                  ...
                  <c:when test="${not empty boardList}">
                    <!-- 해당 데이터가 있을 때 -->
                     <c:forEach var="board" items="${boardList}" varStatus="status">
                        <tr class="tac" data-num="${board.b_num}"><td>${count - status.index}</td>
